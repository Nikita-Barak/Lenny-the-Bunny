...
public class AnimationController : MonoBehaviour
{
    ...
    private readonly List<string> UNIT_IDLE = new List<string>
    {
        "Idle_Up",
        "Idle_Down",
        "Idle_Right",
    ...
    private readonly List<string> UNIT_WALK = new List<string>
    {
        "Walk_Up",
        "Walk_Down",
        "Walk_Right",
    ...
    private readonly List<string> UNIT_RUN = new List<string>
    {
        "Run_Up",
        "Run_Down",
        "Run_Right",
    ...
    private readonly List<string> UNIT_DIE = new List<string>
    {
        "Die_Up",
        "Die_Down",
        "Die_Right",
    ...
    public void HandleMovement(List<string> animationSet, float horizontal, float vertical)
    {
        ...
        if (vertical > 0)
        {
            newAnimation = animationSet[0];
        }
        else if (vertical < 0)
        {
            newAnimation = animationSet[1];
        }
        else if (horizontal > 0 && vertical == 0)
        {
            newAnimation = animationSet[2];
        }
        else if (horizontal < 0 && vertical == 0)
        {
            newAnimation = animationSet[3];
        }
        else
        {
            return;
